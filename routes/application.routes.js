...
import { applyJob, applyJobLibrary, getApplications, updateApplicationStatus, viewApplicationStatus, listAppliedJobs, getApplicationStatusDistribution, getApplicationsByJob, getApplicationsSubmittedOverTime, getAllApplications } from "../controllers/application.controller.js";
import { authenticate } from "../middlewares/auth.middleware.js";

const applicationRouter = Router()

applicationRouter.post('/apply/:jobId',authenticate, applyJob)
applicationRouter.post('/apply-library/:jobId',authenticate, applyJobLibrary)
